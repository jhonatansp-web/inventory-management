...
const mockSettings: UserSetting[]=[
    {label:"Username", value:"Jhonatan", type:'text'},
    {label:"Email", value:"jsaune@senati.pe", type:'text'},
                ...
                {userSettings.map((setting,index)=>(
                    <tr className="hover:bg-blue-50" key={setting.label}>
                        ...
                        <td className="py-2 px-4">
                            {setting.type==='toggle'?(
                                <label htmlFor="" className="inline-flex relative
                                items-center cursor-pointer">
                                    ...
                                    transition peer-checked:after:-translate-x-full
                                ...
                                <input type="text" 
                                className="px-4 py-2 border rouned-lg text-gray-500
