import { useGetDashboardMetricsQuery, 
    ExpenseByCategorySummary, 
    useGetExpensesByCategoryQuery} from "@/state/api"
        ...
        {isLoading?(
            ...
            <>
                ...
                <div className="xl:flex justify-between pr-7">
                    ...
                    <ul className="flex flex-col justify-around items-center xl:items-start py-5
                    gap-3">
                        {
                            expenseCategories.map((entry, index)=>(
                                <li key={`legend-${index}`}
